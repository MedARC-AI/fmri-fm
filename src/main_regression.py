...
DEFAULT_CONFIG = Path(__file__).parents[1] / "config/default_regression.yaml"
...
def main(args: DictConfig):
    ...
    print("regression train/eval fmri-fm")
...
def make_classifiers(
    ...
    for feature_source in args.representations:
        ...
        if len(embed_shape) == 1:
            ...
            clf_fn = partial(AttnPoolClassifier, embed_shape[-1], num_classes)
