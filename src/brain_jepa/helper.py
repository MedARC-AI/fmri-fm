...
import brain_jepa.models.vision_transformer as vit
from brain_jepa.utils.schedulers import (
    WarmupCosineSchedule,
    CosineWDSchedule)

from brain_jepa.utils.tensors import trunc_normal_
...
def init_opt(
    ...
    wd_scheduler = CosineWDSchedule(
        ...
        final_wd=final_wd,
        T_max=int(ipe_scale*num_epochs*iterations_per_epoch/accumulation_steps))
    # Use appropriate scaler based on device availability
